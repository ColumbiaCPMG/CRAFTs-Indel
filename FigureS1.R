...
rAF_hi_chr_distr_plot1
rAF_hi_chr_distr_plot2
rAF_hi_chr_distr_plot3

summary_graph = ggarrange(rAF_hi_chr_distr_plot1, rAF_hi_chr_distr_plot2, rAF_hi_chr_distr_plot3, labels = c("A", "B", "C"), ncol = 1, nrow = 2)
