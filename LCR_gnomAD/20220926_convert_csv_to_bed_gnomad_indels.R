...
indels_AF = read.csv(file = '2023-01-06_gnomad_indels_AF.csv', sep = ',', header = TRUE)
...
write.table(rare_sAF_common_rAF_5_bedfile, "2023-01-06_rare_sAF_common_rAF_5_bedfile.bed", quote = F, row.names = F, col.names = F, sep = "\t")
...
write.table(rare_sAF_common_rAF_10_bedfile, "2023-01-06_rare_sAF_common_rAF_10_bedfile.bed", quote = F, row.names = F, col.names = F, sep = "\t")
...
write.table(rare_sAF_common_rAF_15_bedfile, "2023-01-06_rare_sAF_common_rAF_15_bedfile.bed", quote = F, row.names = F, col.names = F, sep = "\t")
...
write.table(rare_sAF_common_rAF_20_bedfile, "2023-01-06_rare_sAF_common_rAF_20_bedfile.bed", quote = F, row.names = F, col.names = F, sep = "\t")
