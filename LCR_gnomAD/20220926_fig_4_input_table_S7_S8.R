...
rare_sAF_common_rAF_LCR_bp5 = nrow(fread("2023-01-06_LCR_rare_sAF_common_rAF_5.bed", sep = ",", header = FALSE))
rare_sAF_common_rAF_LCR_bp10 = nrow(fread("2023-01-06_LCR_rare_sAF_common_rAF_10.bed", sep = ",", header = FALSE))
rare_sAF_common_rAF_LCR_bp15 = nrow(fread("2023-01-06_LCR_rare_sAF_common_rAF_15.bed", sep = ",", header = FALSE))
rare_sAF_common_rAF_LCR_bp20 = nrow(fread("2023-01-06_LCR_rare_sAF_common_rAF_20.bed", sep = ",", header = FALSE))

## Since the rAF and sAF are both multiplied by two, the rare threshold is also multiplied by 2 
rare <- (1 * 10^-4)


gnomad_indels = read.csv("2023-01-06_gnomad_indels_AF.csv", sep=',', header = TRUE)
...
write.table(gnomad_output_df, paste0( Sys.Date(), "_gnomad_fig4_input.csv"), row.names = FALSE, sep = "," )
